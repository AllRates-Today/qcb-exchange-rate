'use strict';
// Qatar Central Bank exchange rates via the AllRatesToday API.
const BASE = 'https://allratestoday.com/api/v1/central-bank/qcb';
...
/** Latest rate for one pair, e.g. getRate('USD', 'QAR', { apiKey }). */
